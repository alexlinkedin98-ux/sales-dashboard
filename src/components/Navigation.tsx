...
interface NavigationProps {
  currentPage: 'sales' | 'marketing' | 'triage' | 'upsells' | 'reviews' | 'call-analysis' | 'marketing-triage' | 'follow-ups';
}
...
export function Navigation({ currentPage }: NavigationProps) {
  ...
  const isOtherPage = ['upsells', 'reviews', 'call-analysis', 'follow-ups'].includes(currentPage);
