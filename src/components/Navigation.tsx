...
interface NavigationProps {
  currentPage: 'sales' | 'marketing' | 'triage' | 'upsells' | 'reviews' | 'call-analysis' | 'marketing-triage' | 'follow-ups' | 'trainer' | 'sales-checklist' | 'finance' | 'clients';
}
...
export function Navigation({ currentPage }: NavigationProps) {
  ...
  const isOtherPage = ['upsells', 'reviews', 'call-analysis', 'follow-ups', 'sales-checklist', 'finance', 'clients'].includes(currentPage);
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {otherOpen && (
          <div className="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
            ...
            {/* Context-aware links */}
            {(currentPage === 'finance' || currentPage === 'clients') && (
              <>
                <div className="border-t border-gray-100 my-1" />
                <a
                  href="/clients"
            ...
            {currentPage === 'sales' && (
              <>
                ...
                <a
                  href="/triage"
                  className="flex items-center px-4 py-2 text-sm transition-colors text-gray-700 hover:bg-gray-50"
                >
